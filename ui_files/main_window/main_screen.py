...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1474, 995)
        MainWindow.setStyleSheet(u"")
        self.centralwidget = QWidget(MainWindow)
        self.centralwidget.setObjectName(u"centralwidget")
        self.frame = QFrame(self.centralwidget)
        self.frame.setObjectName(u"frame")
        self.frame.setGeometry(QRect(-10, -10, 1471, 961))
...
"background-color: #4693F5")
        ...
        self.messages_scroll.setStyleSheet(u"")
        self.messages_scroll.setWidgetResizable(True)
        self.messages_scroll_widget = QWidget()
        self.messages_scroll_widget.setObjectName(u"messages_scroll_widget")
        self.messages_scroll_widget.setGeometry(QRect(0, 0, 1079, 729))
        self.messages_scroll.setWidget(self.messages_scroll_widget)
        self.Contactlist_scroll = QScrollArea(self.frame)
        self.Contactlist_scroll.setObjectName(u"Contactlist_scroll")
        self.Contactlist_scroll.setGeometry(QRect(20, 110, 361, 841))
        self.Contactlist_scroll.setWidgetResizable(True)
        self.Contactlist_scroll_widget = QWidget()
        self.Contactlist_scroll_widget.setObjectName(u"Contactlist_scroll_widget")
        self.Contactlist_scroll_widget.setGeometry(QRect(0, 0, 359, 839))
        self.Contactlist_scroll.setWidget(self.Contactlist_scroll_widget)
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QMenuBar(MainWindow)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 1474, 21))
